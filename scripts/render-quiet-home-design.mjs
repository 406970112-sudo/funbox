...
const boardFile = "C:/Users/Administrator/Documents/funbox/docs/quiet-home-product-design-v1.html";
const outDir = "C:/Users/Administrator/Documents/funbox/docs";
const boardUrl = `file:///${boardFile.replace(/\\/g, "/")}`;
const port = 9300 + Math.floor(Math.random() * 500);
const userData = mkdtempSync(path.join(tmpdir(), "edge-quiet-home-"));
...
writeFileSync(path.join(outDir, "quiet-home-product-design-v1.png"), Buffer.from(full.data, "base64"));

const labels = ["home", "create", "active", "checkin", "reminder", "privacy"];
for (const phone of layout.result.value.phones) {
  ...
  writeFileSync(
    path.join(outDir, `quiet-home-product-design-v1-${labels[phone.index]}-mobile.png`),
